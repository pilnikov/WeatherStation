    ...
    for (int i = 0; i < nDevices; i++ )
    {
     switch (addr[i])
      ...
      case  0x3F:
        ...
        r_data.lcd_addr = addr[i]; //address of LCD
        DBG_OUT_PORT.print("I2C LCD with address..");
        DBG_OUT_PORT.print(addr[i], HEX);
        DBG_OUT_PORT.println(" found!\n");
      break;
      case  0x27:
        lcd_present = true; //LCD is present
        r_data.lcd_addr = addr[i]; //address of LCD
      ...
      case  0x70:
        ...
        r_data.ht_addr = addr[i]; //HT1633 addr[i]
        DBG_OUT_PORT.println("HT1633 found!\n");
      break;
      case  0x68:
