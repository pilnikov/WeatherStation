...
class HT1621 {
  ...
  public:
    /*!
       ...
       format 3 + 1
       right zero - for alignment to 4 bit
    */
    enum Modes : uint8_t {
      COMMAND_MODE = 0b1000, /*!< This is used for sending standard commands. */
      READ_MODE = 0b1100, /*!< This instructs the HT1621 to prepare for reading the internal RAM. */
      WRITE_MODE = 0b1010, /*!< This instructs the HT1621 to prepare for writing the internal RAM. */
      READ_MODIFY_WRITE_MODE = 0b1010, /*!< This instructs the HT1621 to prepare for reading/modifying batch of internal RAM adresses. */
    ...
    */
    ...
    enum Commands : uint8_t {
      ...
      WDT_DIS   = 0b00000101, /*!< Watch-dog timer disable. */
      TIMER_EN  = 0b00000110, /*!< Enable time base output. */
      WDT_EN    = 0b00000111, /*!< Watch-dog timer enable. The timer is reset. */
      CLR_TIMER = 0b00001100, /*!< Clear the contents of the time base generator. */
      CLR_WDT   = 0b00001110, /*!< Clear the contents of the watch-dog stage. */

      TONE_OFF  = 0b00001000, /*!< Stop emitting the tone signal at the tone pin. \sa TONE2K, TONE4K */
      TONE_ON   = 0b00001001, /*!< Start emitting tone signal at the tone pin. Tone frequency is selected using commands TONE2K or TONE4K. \sa TONE2K, TONE4K */
      TONE2K    = 0b11000000, /*!< Output tone is at 2kHz. */
      TONE4K    = 0b10000000, /*!< Output tone is at 4kHz. */

      RC256K    = 0b00011000, /*!< System oscillator is the internal RC oscillator at 256kHz. */
      XTAL32K   = 0b00010100, /*!< System oscillator is the crystal oscillator at 32768Hz. */
      EXT256K   = 0b00011100, /*!< System oscillator is an external oscillator at 256kHz. */
      ...
      IRQ_EN    = 0b10001000, /*!< Enables IRQ output. This needs to be excuted in SPECIAL_MODE. */
      IRQ_DIS   = 0b10000000, /*!< Disables IRQ output. This needs to be excuted in SPECIAL_MODE. */

      // WDT configuration commands
      F1   = 0b10100000, /*!< Time base/WDT clock. Output = 1Hz. Time-out = 4s. This needs to be excuted in SPECIAL_MODE. */
      F2   = 0b10100001, /*!< Time base/WDT clock. Output = 2Hz. Time-out = 2s. This needs to be excuted in SPECIAL_MODE. */
      F4   = 0b10100010, /*!< Time base/WDT clock. Output = 4Hz. Time-out = 1s. This needs to be excuted in SPECIAL_MODE. */
      F8   = 0b10100011, /*!< Time base/WDT clock. Output = 8Hz. Time-out = .5s. This needs to be excuted in SPECIAL_MODE. */
      F16  = 0b10100100, /*!< Time base/WDT clock. Output = 16Hz. Time-out = .25s. This needs to be excuted in SPECIAL_MODE. */
      F32  = 0b10100101, /*!< Time base/WDT clock. Output = 32Hz. Time-out = .125s. This needs to be excuted in SPECIAL_MODE. */
      F64  = 0b10100110, /*!< Time base/WDT clock. Output = 64Hz. Time-out = .0625s. This needs to be excuted in SPECIAL_MODE. */
      F128 = 0b10100111, /*!< Time base/WDT clock. Output = 128Hz. Time-out = .03125s. This needs to be excuted in SPECIAL_MODE. */

      //Don't use
      TEST_ON   = 0b11100000, /*!< Don't use! Only for manifacturers. This needs SPECIAL_MODE. */
