  ...
  else
  {
    switch (num)
    {
      ...
      case 4:
        ...
        rtc_data.a_hour < 24 && rtc_data.a_min < 59 ? size_buf = snprintf(buf, 250, " Будильник зазвонит в %2d:%02d  Текущая яркость: %2d", rtc_data.a_hour, rtc_data.a_min, cur_br)
            : size_buf = snprintf(buf, 60, " Будильник не установлен  Текущая яркость:%2d", cur_br);
        break;
      default:
        break;
    }
