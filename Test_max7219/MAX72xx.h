...
/**
 * \file
 * \brief Main header file for the MAX72xx library
 */
...
- Removed 'drawXXX' graphics functions to new MAXPanel library.
...
- Added MAX72xx_Message_ESP8266 example
...
related to the main header file MAX72xx.h.
...
/**
 * Core object for the MAX72XX library
 */
class MAX72XX
{
public:
  ...
  */
   ...
   *                    on this parameter.
   */
  MAX72XX(moduleType_t mod, uint8_t dataPin, uint8_t clkPin, uint8_t csPin, uint8_t numDevices=1);
   ...
   *                    on this parameter.
   */
  MAX72XX(moduleType_t mod, uint8_t csPin, uint8_t numDevices=1);
   ...
   *                    on this parameter.
   */
  MAX72XX(moduleType_t mod, SPIClass &spi, uint8_t csPin, uint8_t numDevices = 1);
