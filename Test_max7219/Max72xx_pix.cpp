...
void MAX72XX::clear(uint8_t startDev, uint8_t endDev)
{
...
bool MAX72XX::getBuffer(uint16_t col, uint8_t size, uint8_t *pd)
{
...
bool MAX72XX::setBuffer(uint16_t col, uint8_t size, uint8_t *pd)
{
...
bool MAX72XX::getPoint(uint8_t r, uint16_t c)
{
...
bool MAX72XX::setPoint(uint8_t r, uint16_t c, bool state)
{
  uint8_t buf = c/COL_SIZE;
  c %= COL_SIZE;
...
bool MAX72XX::setRow(uint8_t startDev, uint8_t endDev, uint8_t r, uint8_t value)
{
  bool b = _updateEnabled;
...
bool MAX72XX::transform(uint8_t startDev, uint8_t endDev, transformType_t ttype)
{
 // uint8_t t[ROW_SIZE];
  uint8_t colData;
  bool b = _updateEnabled;
