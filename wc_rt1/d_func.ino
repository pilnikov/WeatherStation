...
void s7_write_all(uint8_t dtyp, scr_buff_t buff)
{
	...
	case 3:
		...
		tm1637->display(4, dig3[0]);
		tm1637->display(5, dig3[1]);
		break;
	case 12:
		tm1637->display(0, f_dsp.roll_seg(dig2[0]));//1
		tm1637->display(1, f_dsp.roll_seg(dig2[1]));//2
		tm1637->display(2, f_dsp.roll_seg(dig2[2]));//3
		tm1637->display(3, f_dsp.roll_seg(dig2[3]));//4
	/*
		tm1637->display(0, 0x0, dig2[0]); //13
		tm1637->display(1, 0x0, dig2[1]); //14
		tm1637->display(2, 0x0, dig2[2]); //15
		tm1637->display(3, 0x0, dig2[3]); //16

		tm1637->display(0, 0x0, dig2[0]); //5
		tm1637->display(1, 0x0, dig2[1]); //6
		tm1637->display(2, 0x0, dig2[2]); //7
		tm1637->display(3, 0x0, dig2[3]); //8

		tm1637->display(4, dig2[0], 0x0); //9
		tm1637->display(5, dig2[1], 0x0); //10
		tm1637->display(6, dig2[2], 0x0); //11
		tm1637->display(7, dig2[3], 0x0); //12
	*/
		break;
	case 5:
